            ...
            <div class="space-y-6">
              ...
              <div class="space-y-4">
                <a href="mailto:hello@time2value.com"
                  ...
                  <div>
                    <div class="font-inter font-semibold">Email</div>
                ...
                <a href="#" class="flex items-center text-gray-300 hover:text-white transition-colors group">
                  ...
                  <div>
                    <div class="font-inter font-semibold">LinkedIn</div>
                ...
                <div class="flex items-center text-gray-300">
                  ...
                  <div>
                    <div class="font-inter font-semibold">Response Time</div>
                    <div class="text-gray-400 font-opensans text-sm">Usually within 4 hours</div>
                  </div>
                </div>
              </div>
            </div>
